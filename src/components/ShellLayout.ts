...
function initShellLayout(): void {
  ...
  const codeToggle =
    document.querySelector<HTMLButtonElement>("[data-toggle-code]");
  ...
  const codeHandle = document.querySelector<HTMLElement>(
    '[data-resize="code"]',
  );
